...
#include "NativizedAssets/Public/GripEnum__pf563933975.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeGripEnum__pf563933975() {}
...
// End Cross Module References
	...
	{
		class UPackage* EnumPackage = FindOrConstructDynamicTypePackage(TEXT("/Game/VirtualRealityBP/Blueprints/GripEnum"));
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_E__GripEnum__pf(E__GripEnum__pf_StaticEnum, TEXT("/Game/VirtualRealityBP/Blueprints/GripEnum"), TEXT("GripEnum"), true, TEXT("/Game/VirtualRealityBP/Blueprints/GripEnum"), TEXT("/Game/VirtualRealityBP/Blueprints/GripEnum.GripEnum"));
	uint32 Get_Z_Construct_UEnum_NativizedAssets_E__GripEnum__pf_Hash() { return 2516568018U; }
	UEnum* Z_Construct_UEnum_NativizedAssets_E__GripEnum__pf()
	{
		UPackage* Outer = FindOrConstructDynamicTypePackage(TEXT("/Game/VirtualRealityBP/Blueprints/GripEnum"));		UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("GripEnum"), 0, Get_Z_Construct_UEnum_NativizedAssets_E__GripEnum__pf_Hash(), true);
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "Public/GripEnum__pf563933975.h" },
				...
				{ "ReplaceConverted", "/Game/VirtualRealityBP/Blueprints/GripEnum.GripEnum" },
			};
#endif
			static const UE4CodeGen_Private::FEnumParams EnumParams = {
				(UObject*(*)())[](){ return (UObject*)FindOrConstructDynamicTypePackage(TEXT("/Game/VirtualRealityBP/Blueprints/GripEnum")); },
