...
#include "BP_PickupCube__pf563933975.h"
...
ABP_PickupCube_C__pf563933975::ABP_PickupCube_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__0)
	{
		...
		__Local__1 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_PickupCube_C__pf563933975::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		...
		__Local__0->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_PickupCube_C__pf563933975::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		...
		auto& __Local__5 = (*(AccessPrivateProperty<FVector >((__Local__0), USceneComponent::__PPO__RelativeScale3D() )));
		__Local__5 = FVector(0.200000, 0.200000, 0.200000);
		...
		(((FBoolProperty*)__Local__6)->SetPropertyValue_InContainer((__Local__0), true, 0));
	...
	{
		__Local__9 = (AActor::StaticClass())->FindPropertyByName(FName(TEXT("bCanBeDamaged")));
		check(__Local__9);
		__Local__10 = __Local__9;
	}
	(((FBoolProperty*)__Local__9)->SetPropertyValue_InContainer((this), true, 0));
...
void ABP_PickupCube_C__pf563933975::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PickupCube_C__pf563933975::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_PickupCube_C__pf563933975::bpf__ExecuteUbergraph_BP_PickupCube__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ABP_PickupCube_C__pf563933975::bpf__ExecuteUbergraph_BP_PickupCube__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABP_PickupCube_C__pf563933975::bpf__Drop__pf()
{
	bpf__ExecuteUbergraph_BP_PickupCube__pf_0(4);
}
void ABP_PickupCube_C__pf563933975::bpf__Pickup__pf(USceneComponent* bpp__AttachTo__pf)
{
	b0l__K2Node_Event_AttachTo__pf = bpp__AttachTo__pf;
	bpf__ExecuteUbergraph_BP_PickupCube__pf_1(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PickupCube_C__pf563933975::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{86, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  StaticMesh /Game/Geometry/Meshes/1M_Cube.1M_Cube 
		{87, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  MaterialInstanceConstant /Game/VirtualReality/Materials/MI_SmallCubes.MI_SmallCubes 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PickupCube_C__pf563933975::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{75, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/VirtualRealityBP/Blueprints/Interfaces/PickupActorInterface.PickupActorInterface_C 
		...
		{88, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.StaticMeshActor 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_PickupCube_C__pf563933975
{
	FRegisterHelper__ABP_PickupCube_C__pf563933975()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/VirtualRealityBP/Blueprints/BP_PickupCube"), &ABP_PickupCube_C__pf563933975::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_PickupCube_C__pf563933975 Instance;
};
FRegisterHelper__ABP_PickupCube_C__pf563933975 FRegisterHelper__ABP_PickupCube_C__pf563933975::Instance;
