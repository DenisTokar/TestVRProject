...
ABP_ClimbCube_C__pf563933975::ABP_ClimbCube_C__pf563933975(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	__Local__2 = FVector(10.000000, 10.000000, 10.000000);
	...
	bpv__FistMC__pf = nullptr;
	bpv__SecondMC__pf = nullptr;
	bpv__MotionControllerPawn__pf = nullptr;
	bpv__PivotFMCPoint__pf = FVector(0.000000, 0.000000, 0.000000);
	bpv__PivotSMCPoint__pf = FVector(0.000000, 0.000000, 0.000000);
...
void ABP_ClimbCube_C__pf563933975::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_ClimbCube_C__pf563933975::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_ClimbCube_C__pf563933975::bpf__ExecuteUbergraph_BP_ClimbCube__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 1:
			{
				if(::IsValid(bpv__MotionControllerPawn__pf) && ::IsValid(bpv__MotionControllerPawn__pf->bpv__Box__pf))
				{
					bpv__MotionControllerPawn__pf->bpv__Box__pf->SetAllPhysicsLinearVelocity(FVector(0.000000,0.000000,0.000000), false);
				}
				__CurrentState = -1;
				break;
			}
		case 2:
			{
				if(::IsValid(bpv__SecondMC__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf = bpv__SecondMC__pf->USceneComponent::K2_GetComponentLocation();
				}
				bpv__PivotSMCPoint__pf = bpfv__CallFunc_K2_GetComponentLocation_ReturnValue__pf;
			}
		case 3:
			{
		...
		case 4:
			{
				bpv__MotionControllerPawn__pf = b0l__K2Node_DynamicCast_AsMotion_Controller_Pawn__pf;
			}
		case 5:
			{
				int32  __Local__4 = 0;
				bpfv__CallFunc_Add_IntInt_ReturnValue__pf = UKismetMathLibrary::Add_IntInt(((::IsValid(bpv__MotionControllerPawn__pf)) ? (bpv__MotionControllerPawn__pf->bpv__ClimbHands__pf) : (__Local__4)), 1);
				b0l__Temp_int_Variable__pf = bpfv__CallFunc_Add_IntInt_ReturnValue__pf;
			}
		case 6:
			{
				if(::IsValid(bpv__MotionControllerPawn__pf))
				{
					bpv__MotionControllerPawn__pf->bpv__ClimbHands__pf = b0l__Temp_int_Variable__pf;
				}
			}
		case 7:
			{
				bpfv__CallFunc_GreaterEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::GreaterEqual_IntInt(b0l__Temp_int_Variable__pf, 2);
		...
		case 8:
			{
				if(::IsValid(bpv__MotionControllerPawn__pf))
				{
					bpv__MotionControllerPawn__pf->bpv__ClimbHands__pf = 2;
				}
				__CurrentState = 1;
				break;
			}
		...
		case 20:
			{
				bpfv__CallFunc_IsValid_ReturnValue_2__pf = UKismetSystemLibrary::IsValid(bpv__FistMC__pf);
		...
		case 21:
			{
				bpv__SecondMC__pf = b0l__K2Node_Event_MotionController_1__pf;
				__CurrentState = 2;
				break;
			}
		case 22:
			{
				bpv__FistMC__pf = b0l__K2Node_Event_MotionController_1__pf;
			}
		case 23:
			{
				if(::IsValid(bpv__FistMC__pf))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_2__pf = bpv__FistMC__pf->USceneComponent::K2_GetComponentLocation();
				}
				bpv__PivotFMCPoint__pf = bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_2__pf;
				__CurrentState = 3;
				break;
			}
		default:
...
void ABP_ClimbCube_C__pf563933975::bpf__ExecuteUbergraph_BP_ClimbCube__pf_1(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 9:
			{
				bpfv__CallFunc_LessEqual_IntInt_ReturnValue__pf = UKismetMathLibrary::LessEqual_IntInt(b0l__Temp_int_Variable_1__pf, 0);
		...
		case 10:
			{
				if(::IsValid(bpv__MotionControllerPawn__pf))
				{
					bpv__MotionControllerPawn__pf->bpv__ClimbHands__pf = 0;
				}
				__CurrentState = -1;
				break;
			}
		...
		case 25:
			{
				bpfv__CallFunc_EqualEqual_ObjectObject_ReturnValue__pf = UKismetMathLibrary::EqualEqual_ObjectObject(b0l__K2Node_Event_MotionController__pf, bpv__FistMC__pf);
		...
		case 26:
			{
				bpv__FistMC__pf = ((USceneComponent*)nullptr);
			}
		case 27:
			{
				int32  __Local__5 = 0;
				bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf = UKismetMathLibrary::Subtract_IntInt(((::IsValid(bpv__MotionControllerPawn__pf)) ? (bpv__MotionControllerPawn__pf->bpv__ClimbHands__pf) : (__Local__5)), 1);
				b0l__Temp_int_Variable_1__pf = bpfv__CallFunc_Subtract_IntInt_ReturnValue__pf;
			}
		case 28:
			{
				if(::IsValid(bpv__MotionControllerPawn__pf))
				{
					bpv__MotionControllerPawn__pf->bpv__ClimbHands__pf = b0l__Temp_int_Variable_1__pf;
				}
				__CurrentState = 9;
				break;
			}
		case 29:
			{
				bpv__SecondMC__pf = ((USceneComponent*)nullptr);
				__CurrentState = 27;
				break;
			}
		default:
...
void ABP_ClimbCube_C__pf563933975::bpf__ExecuteUbergraph_BP_ClimbCube__pf_2(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 12:
			{
				bpfv__CallFunc_IsValid_ReturnValue__pf = UKismetSystemLibrary::IsValid(bpv__MotionControllerPawn__pf);
		...
		case 13:
			{
				bpfv__CallFunc_IsValid_ReturnValue_6__pf = UKismetSystemLibrary::IsValid(bpv__SecondMC__pf);
				b0l__Temp_bool_Variable_1__pf = bpfv__CallFunc_IsValid_ReturnValue_6__pf;
				bpfv__CallFunc_IsValid_ReturnValue_7__pf = UKismetSystemLibrary::IsValid(TSwitchValue<bool , USceneComponent* >(b0l__Temp_bool_Variable_1__pf, b0l__K2Node_Select_Default_1__pf, 2, TSwitchPair<bool , USceneComponent* >(false, bpv__FistMC__pf), TSwitchPair<bool , USceneComponent* >(true, bpv__SecondMC__pf)));
		...
		case 14:
			{
				bpfv__CallFunc_IsValid_ReturnValue_1__pf = UKismetSystemLibrary::IsValid(bpv__SecondMC__pf);
				b0l__Temp_bool_Variable__pf = bpfv__CallFunc_IsValid_ReturnValue_1__pf;
				if(::IsValid(TSwitchValue<bool , USceneComponent* >(b0l__Temp_bool_Variable__pf, b0l__K2Node_Select_Default__pf, 2, TSwitchPair<bool , USceneComponent* >(false, bpv__FistMC__pf), TSwitchPair<bool , USceneComponent* >(true, bpv__SecondMC__pf))))
				{
					bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf = TSwitchValue<bool , USceneComponent* >(b0l__Temp_bool_Variable__pf, b0l__K2Node_Select_Default__pf, 2, TSwitchPair<bool , USceneComponent* >(false, bpv__FistMC__pf), TSwitchPair<bool , USceneComponent* >(true, bpv__SecondMC__pf))->USceneComponent::K2_GetComponentLocation();
				}
				bpfv__CallFunc_IsValid_ReturnValue_4__pf = UKismetSystemLibrary::IsValid(bpv__SecondMC__pf);
				b0l__Temp_bool_Variable_2__pf = bpfv__CallFunc_IsValid_ReturnValue_4__pf;
				bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf = UKismetMathLibrary::Subtract_VectorVector(TSwitchValue<bool , FVector >(b0l__Temp_bool_Variable_2__pf, b0l__K2Node_Select_Default_2__pf, 2, TSwitchPair<bool , FVector >(false, bpv__PivotFMCPoint__pf), TSwitchPair<bool , FVector >(true, bpv__PivotSMCPoint__pf)), bpfv__CallFunc_K2_GetComponentLocation_ReturnValue_1__pf);
				bpfv__CallFunc_GetWorldDeltaSeconds_ReturnValue__pf = UGameplayStatics::GetWorldDeltaSeconds(this);
				bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_FloatFloat(bpfv__CallFunc_GetWorldDeltaSeconds_ReturnValue__pf, 16.000000);
				bpfv__CallFunc_VLerp_ReturnValue__pf = UKismetMathLibrary::VLerp(FVector(0.000000,0.000000,0.000000), bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf, bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf);
				if(::IsValid(bpv__MotionControllerPawn__pf))
				{
					bpv__MotionControllerPawn__pf->AActor::K2_AddActorWorldOffset(bpfv__CallFunc_VLerp_ReturnValue__pf, false, /*out*/ b0l__CallFunc_K2_AddActorWorldOffset_SweepHitResult__pf, false);
				}
			}
		case 15:
			{
				bpfv__CallFunc_IsValid_ReturnValue_3__pf = UKismetSystemLibrary::IsValid(bpv__FistMC__pf);
		...
		case 16:
			{
				if(::IsValid(bpv__FistMC__pf))
				{
					bpv__FistMC__pf->USceneComponent::K2_SetWorldLocation(bpv__PivotFMCPoint__pf, false, /*out*/ b0l__CallFunc_K2_SetWorldLocation_SweepHitResult__pf, false);
				}
			}
		case 17:
			{
				bpfv__CallFunc_IsValid_ReturnValue_5__pf = UKismetSystemLibrary::IsValid(bpv__SecondMC__pf);
		...
		case 18:
			{
				if(::IsValid(bpv__SecondMC__pf))
				{
					bpv__SecondMC__pf->USceneComponent::K2_SetWorldLocation(bpv__PivotSMCPoint__pf, false, /*out*/ b0l__CallFunc_K2_SetWorldLocation_SweepHitResult_1__pf, false);
				}
				__CurrentState = -1;
				break;
			}
...
void ABP_ClimbCube_C__pf563933975::bpf__LetGo__pf(USceneComponent* bpp__MotionController__pf)
{
	b0l__K2Node_Event_MotionController__pf = bpp__MotionController__pf;
	bpf__ExecuteUbergraph_BP_ClimbCube__pf_1(24);
}
void ABP_ClimbCube_C__pf563933975::bpf__Climb__pf(USceneComponent* bpp__MotionController__pf)
{
	b0l__K2Node_Event_MotionController_1__pf = bpp__MotionController__pf;
	bpf__ExecuteUbergraph_BP_ClimbCube__pf_0(19);
}
void ABP_ClimbCube_C__pf563933975::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BP_ClimbCube__pf_2(11);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_ClimbCube_C__pf563933975::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_ClimbCube_C__pf563933975::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{25, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /Game/VirtualRealityBP/Blueprints/Interfaces/ClimbActorInterface.ClimbActorInterface_C 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_ClimbCube_C__pf563933975
{
	FRegisterHelper__ABP_ClimbCube_C__pf563933975()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/VirtualRealityBP/Blueprints/BP_ClimbCube"), &ABP_ClimbCube_C__pf563933975::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_ClimbCube_C__pf563933975 Instance;
};
FRegisterHelper__ABP_ClimbCube_C__pf563933975 FRegisterHelper__ABP_ClimbCube_C__pf563933975::Instance;
