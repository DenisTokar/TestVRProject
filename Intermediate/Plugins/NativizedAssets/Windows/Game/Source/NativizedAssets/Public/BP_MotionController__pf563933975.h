...
class ABP_Ladder_C__pf563933975;
...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Use Teleport", Category="Default", MultiLine="true", OverrideNativeName="UseTeleport"))
	bool bpv__UseTeleport__pf;
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="BP Ladder", Category="Default", MultiLine="true", OverrideNativeName="BP_Ladder"))
	ABP_Ladder_C__pf563933975* bpv__BP_Ladder__pf;
	UPROPERTY(EditInstanceOnly, BlueprintReadWrite, meta=(DisplayName="BP Pawn", Category="Default", MultiLine="true", ExposeOnSpawn="true", OverrideNativeName="BP_Pawn"))
	AMotionControllerPawn_C__pf563933975* bpv__BP_Pawn__pf;
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, meta=(DisplayName="Climb Actor", Category="Default", MultiLine="true", OverrideNativeName="ClimbActor"))
	AActor* bpv__ClimbActor__pf;
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="K2Node_DynamicCast_AsBP_Ladder"))
	ABP_Ladder_C__pf563933975* b0l__K2Node_DynamicCast_AsBP_Ladder__pf;
	...
	UPROPERTY(Transient, DuplicateTransient, meta=(OverrideNativeName="K2Node_CustomEvent_On"))
	bool b0l__K2Node_CustomEvent_On__pf;
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="CE_TeleportUse"))
	virtual void bpf__CE_TeleportUse__pf(bool bpp__On__pf);
