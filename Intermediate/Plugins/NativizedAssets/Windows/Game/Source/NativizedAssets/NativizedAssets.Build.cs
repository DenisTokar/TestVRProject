...
public class NativizedAssets : ModuleRules
{
	public NativizedAssets(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(new string[] { "CoreUObject", "MagicLeapARPin", "NavigationSystem", "UMG", "AnimGraphRuntime", "InputCore", "ClothingSystemRuntimeNv", "HeadMountedDisplay", "PhysicsCore", "SteamVR", "SlateCore", "Landscape", "StaticMeshDescription", "MeshDescription", "AudioExtensions", "AudioPlatformConfiguration", "AIModule", "GameplayTasks", "GameplayTags", "ClothingSystemRuntimeInterface", "PropertyAccess", "PropertyPath", "MovieScene", "Slate", "AudioMixer" });
